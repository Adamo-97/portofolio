...
export const CATEGORIES: Record<CategoryKey, { title: string; blurb: string }> = {
  Languages:       { title: "Languages",       blurb: "Core programming languages that power everything else." },
  Frontend:        { title: "Frontend",        blurb: "Interfaces, frameworks, and the craft of the browser." },
  "Backend & Data":{ title: "Backend & Data",  blurb: "APIs, services, storage engines, and query layers." },
  Mobile:          { title: "Mobile",          blurb: "Native and cross-platform stacks for phones and tablets." },
  "Design & IDEs": { title: "Design & IDEs",   blurb: "Visual tools and editors that shape the dev loop." },
  "QA & Workflow": { title: "QA & Workflow",   blurb: "Testing, automation, and the glue for calm ops." },
};
